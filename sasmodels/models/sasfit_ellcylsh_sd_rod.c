...
double Iq( double q, double R0,  double SIGMA_R0,  double EPSILON,  double T,
           double DUMMY1,  double LL,  double SIGMA_L,  double ETA_CORE,  double ETA_SHELL,
...
double Iqxy( double qx, double qy, double R0, double SIGMA_R0, double EPSILON,
             double T, double DUMMY1, double LL, double SIGMA_L, double ETA_CORE,
...
*/
// define shortcuts for local R0, SIGMA_R0, EPSILON, T, DUMMY1, LL, SIGMA_L, ETA_CORE, ETA_SHELL, ETA_SOLV, R, Q, P0, LB, B, L, EXVOL, CLBeters/variables
double Iq( double q, double R0,  double SIGMA_R0,  double EPSILON,  double T,
           double DUMMY1,  double LL,  double SIGMA_L,  double ETA_CORE,  double ETA_SHELL,
           double ETA_SOLV,  double R,  double Q,  double P0,  double LB,  double B,
           double L,  double EXVOL,  double CLB)
...
// insert your code here
    Pcs=sasfit_ff_pcs_ellcylsh(q,R0, SIGMA_R0, EPSILON, T, DUMMY1, LL, SIGMA_L,
                               ETA_CORE, ETA_SHELL, ETA_SOLV, R, Q, P0, LB, B, L, EXVOL, CLB);
             ...
             double B, double L, double EXVOL, double CLB)
{
    ...
    return Iq( q, R0, SIGMA_R0, EPSILON, T, DUMMY1, LL, SIGMA_L, ETA_CORE,
