        ...
        sasfit_param * param)
{
    ...
    res = 2.0*sasfit_integrate(0.0, M_PI/2.0,
                               &sasfit_ff_magneticfieldalignedvesicle_p2psi_kernel_theta, param);
    return res;
}
double sasfit_ff_magneticfieldalignedvesicle_p2psi(double q,
        sasfit_param * param)
{
    double res,err;
    double xl[3], xu[3];
...
double sasfit_ff_magneticfieldalignedvesicle_p2psi_f(double q,
        sasfit_param * param)
{
// insert your code here
    return 0.0;
}
double sasfit_ff_magneticfieldalignedvesicle_p2psi_v(double q,
