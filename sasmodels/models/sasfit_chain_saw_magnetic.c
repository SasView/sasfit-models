...
// insert your code here
    ...
    ETA_MAG_CORE=0.0;
    ETA_MAG_SHELL=0.0;
    iso = (1.0+POL)/2.0*(FFmicelle_pp(q,R_CORE, SNAGG, VBRUSH, RG, T_BRUSH_CONST,
                                      ...
                                      T_SH, I, C, LAMBDA, R02, ALPHA_SH, ZMAX, Q, DTHETA)+FFmicelle_pm(q,R_CORE,
                                              SNAGG, VBRUSH, RG, T_BRUSH_CONST, SIGMA_BRUSH_GAUSSIAN, POL, L_B, P0, R_TOT,
          ...
          + (1.0-POL)/2.0*(FFmicelle_mm(q,R_CORE, SNAGG, VBRUSH, RG, T_BRUSH_CONST,
                                        SIGMA_BRUSH_GAUSSIAN, POL, L_B, P0, R_TOT, T_SHELL, SNAGG, VBRUSH, ETA_CORE,
                                        ETA_SHELL, ETA_BRUSH, ETA_SOLV, ETA_MAG_CORE, ETA_MAG_SHELL, R_AV, ALPHA, RG,
                                        PSIDEG, POL, PEP, YAWPEP, SIGYAW, P, A, TAU, T_BRUSH_CONST,
                                        SIGMA_BRUSH_GAUSSIAN, L_B, TPLUS, TMINUS, PSI, NAGG, RW_SAW, RADAVG, R_CORE,
                                        T_SH, I, C, LAMBDA, R02, ALPHA_SH, ZMAX, Q, DTHETA)+FFmicelle_mp(q,R_CORE,
                                                SNAGG, VBRUSH, RG, T_BRUSH_CONST, SIGMA_BRUSH_GAUSSIAN, POL, L_B, P0, R_TOT,
                                                T_SHELL, SNAGG, VBRUSH, ETA_CORE, ETA_SHELL, ETA_BRUSH, ETA_SOLV, ETA_MAG_CORE,
                                                ETA_MAG_SHELL, R_AV, ALPHA, RG, PSIDEG, POL, PEP, YAWPEP, SIGYAW, P, A, TAU,
                                                T_BRUSH_CONST, SIGMA_BRUSH_GAUSSIAN, L_B, TPLUS, TMINUS, PSI, NAGG, RW_SAW,
    ...
    aniso =	(1.0+POL)/2.0*(FFmicelle_pp(q,R_CORE, SNAGG, VBRUSH, RG, T_BRUSH_CONST,
                                        SIGMA_BRUSH_GAUSSIAN, POL, L_B, P0, R_TOT, T_SHELL, SNAGG, VBRUSH, ETA_CORE,
                                        ETA_SHELL, ETA_BRUSH, ETA_SOLV, ETA_MAG_CORE, ETA_MAG_SHELL, R_AV, ALPHA, RG,
                                        PSIDEG, POL, PEP, YAWPEP, SIGYAW, P, A, TAU, T_BRUSH_CONST,
                                        SIGMA_BRUSH_GAUSSIAN, L_B, TPLUS, TMINUS, PSI, NAGG, RW_SAW, RADAVG, R_CORE,
...
{
// insert your code here
    return V(R_CORE+T_SH,R_CORE, SNAGG, VBRUSH, RG, T_BRUSH_CONST,
             SIGMA_BRUSH_GAUSSIAN, POL, L_B, P0, R_TOT, T_SHELL, SNAGG, VBRUSH, ETA_CORE,
             ETA_SHELL, ETA_BRUSH, ETA_SOLV, ETA_MAG_CORE, ETA_MAG_SHELL, R_AV, ALPHA, RG,
             PSIDEG, POL, PEP, YAWPEP, SIGYAW, P, A, TAU, T_BRUSH_CONST,
             SIGMA_BRUSH_GAUSSIAN, L_B, TPLUS, TMINUS, PSI, NAGG, RW_SAW, RADAVG, R_CORE,
             T_SH, I, C, LAMBDA, R02, ALPHA_SH, ZMAX, Q, DTHETA)+Vg(R_CORE+T_SH,
                     SIGMA_BRUSH_GAUSSIAN);
}
double Iqxy( double qx, double qy, double R_CORE, double SNAGG, double VBRUSH,
             double RG, double T_BRUSH_CONST, double SIGMA_BRUSH_GAUSSIAN, double POL,
             double L_B, double P0, double R_TOT, double T_SHELL, double SNAGG,
