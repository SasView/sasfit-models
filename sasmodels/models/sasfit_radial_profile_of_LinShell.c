...
double sasfit_ff_radial_profile_of_linshell(double r, sasfit_param * param)
{
...
double sasfit_ff_radial_profile_of_linshell_f(double q, sasfit_param * param)
{
// insert your code here
    return 0.0;
}
double sasfit_ff_radial_profile_of_linshell_v(double q, sasfit_param * param,
        int dist)
{
// insert your code here
    return 0.0;
             ...
             double ETA_SHELL, double X_IN_SOL, double X_OUT_SOL, double ETA_SOL)
{
    ...
    return Iq( q, R_CORE, DR, ETA_CORE, ETA_SHELL, X_IN_SOL, X_OUT_SOL, ETA_SOL);
}
