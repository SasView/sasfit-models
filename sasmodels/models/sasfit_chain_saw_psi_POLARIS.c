...
// insert your code here
    ...
    return	(1.0+POL)/2.0*(TPLUS *FFmicelle_pp(q,R_CORE, SNAGG, VBRUSH, RG,
                           T_BRUSH_CONST, SIGMA_BRUSH_GAUSSIAN, POL, L_B, P0, R_TOT, T_SHELL, SNAGG,
                           ...
                           T_SH, I, C, LAMBDA, R02, ALPHA_SH, ZMAX, Q, DTHETA)+TMINUS*FFmicelle_pm(q,
                                   R_CORE, SNAGG, VBRUSH, RG, T_BRUSH_CONST, SIGMA_BRUSH_GAUSSIAN, POL, L_B, P0,
            ...
            +	(1.0-POL)/2.0*(TMINUS*FFmicelle_mm(q,R_CORE, SNAGG, VBRUSH, RG, T_BRUSH_CONST,
                               ...
                               SIGMA_BRUSH_GAUSSIAN, L_B, TPLUS, TMINUS, PSI, NAGG, RW_SAW, RADAVG, R_CORE,
                               T_SH, I, C, LAMBDA, R02, ALPHA_SH, ZMAX, Q, DTHETA)+TPLUS *FFmicelle_mp(q,
                                       R_CORE, SNAGG, VBRUSH, RG, T_BRUSH_CONST, SIGMA_BRUSH_GAUSSIAN, POL, L_B, P0,
                                       R_TOT, T_SHELL, SNAGG, VBRUSH, ETA_CORE, ETA_SHELL, ETA_BRUSH, ETA_SOLV,
                                       ETA_MAG_CORE, ETA_MAG_SHELL, R_AV, ALPHA, RG, PSIDEG, POL, PEP, YAWPEP, SIGYAW,
                                       P, A, TAU, T_BRUSH_CONST, SIGMA_BRUSH_GAUSSIAN, L_B, TPLUS, TMINUS, PSI, NAGG,
