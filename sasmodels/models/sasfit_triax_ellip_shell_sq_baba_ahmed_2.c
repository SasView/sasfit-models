...
double sasfit_ff_triax_ellip_shell_sq_baba_ahmed_2_core(double y,  double A,
...
double sasfit_ff_triax_ellip_shell_sq_baba_ahmed_2_core_x(double x,  double A,
        double DELTA_B,  double DELTA_C,  double T,  double ETA_C,  double ETA_SH_DRY,
        double ETA_SOL,  double PHI,  double V_POL_AP,  double ALPHA,  double Z_P,
        double EPSILON_R,  double MB,  double ZB,  double TEMP,  double P0)
{
    ...
    res = sasfit_integrate(0.0, 1.0,
                           sasfit_ff_triax_ellip_shell_sq_baba_ahmed_2_core, A, DELTA_B, DELTA_C, T, ETA_C,
           ...
           double ZB,  double TEMP,  double P0)
{
    ...
    res = sasfit_integrate(0.0, 1.0,
                           sasfit_ff_triax_ellip_shell_sq_baba_ahmed_2_core_x, A, DELTA_B, DELTA_C, T,
