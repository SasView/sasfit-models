...
double sasfit_ff_linshell(double q, sasfit_param * param)
{
    return sas_pow_2(sasfit_ff_linshell_f(q,param));
}
double sasfit_ff_linshell_f(double q, sasfit_param * param)
{
...
double sasfit_ff_linshell_v(double q, sasfit_param * param, int dist)
{
// insert your code here
    return 0.0;
}
