...
double Iq( double q, double R_CORE,  double SNAGG,  double VBRUSH,  double RG,
           double POL,  double T_BRUSH_CONST,  double SIGMA_BRUSH_GAUSSIAN,  double L_B,
...
double Iqxy( double qx, double qy, double R_CORE, double SNAGG, double VBRUSH,
             double RG, double POL, double T_BRUSH_CONST, double SIGMA_BRUSH_GAUSSIAN,
...
// insert your code here
    ...
    return POL*(FFmicelle_pp(q,R_CORE, SNAGG, VBRUSH, RG, POL, T_BRUSH_CONST,
                             SIGMA_BRUSH_GAUSSIAN, L_B, P0, R_TOT, T_SHELL, SNAGG, VBRUSH, ETA_CORE,
                             ...
                             T_SH, I, C, LAMBDA, R02, ALPHA_SH, ZMAX, Q, DTHETA)-FFmicelle_mm(q,R_CORE,
                                     SNAGG, VBRUSH, RG, POL, T_BRUSH_CONST, SIGMA_BRUSH_GAUSSIAN, L_B, P0, R_TOT,
             ...
             double ZMAX, double Q, double DTHETA)
{
    ...
    return Iq( q, R_CORE, SNAGG, VBRUSH, RG, POL, T_BRUSH_CONST,
               SIGMA_BRUSH_GAUSSIAN, L_B, P0, R_TOT, T_SHELL, SNAGG, VBRUSH, ETA_CORE,
               ETA_SHELL, ETA_BRUSH, ETA_SOLV, ETA_MAG_CORE, ETA_MAG_SHELL, R_AV, ALPHA, RG,
               PSIDEG, POL, PEP, YAWPEP, SIGYAW, P, A, TAU, T_BRUSH_CONST,
               SIGMA_BRUSH_GAUSSIAN, L_B, TPLUS, TMINUS, PSI, NAGG, RW_SAW, RADAVG, R_CORE,
